...
| SwitchHead expanded-seed robustness | One-layer and two-layer output-selector induced conditions both reached routed match `1.00` across seeds 1-10; two-layer top components were `L1E0`/`L1E1` in all 10 seeds. | The core induced SwitchHead result is not a five-seed accident. |
